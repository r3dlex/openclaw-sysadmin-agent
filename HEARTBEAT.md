...
- Maintenance completed, security findings, disk warnings.
  Example: "Brew upgrade: 3 packages updated. Disk at 65%."
- Service outages, security findings, critical issues: report IMMEDIATELY.
